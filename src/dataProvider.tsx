...
import {DataProvider, withLifecycleCallbacks, HttpError, fetchUtils} from 'react-admin';
...
const dataProvider = simpleRestProvider('https://tasker.kirychuk.pp.ua/api/v1', fetchJson);
